    ...
    <Popover>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="h-px bg-foreground/[0.06]" />
          <FormulaItem
            description="Measures how steady your speed was. Ïƒ is standard deviation, Î¼ is mean of per-second WPM. 100% means perfectly even pacing."
            formula="100 - (Ïƒ / Î¼ x 100)"
            label="Consistency"
          />
        </div>
      </PopoverContent>
