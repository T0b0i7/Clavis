...
export const metadata: Metadata = {
  title: {
    default:
      "Clavis — Free Typing Test with Mechanical Keyboard Sounds | WPM & Accuracy",
    template: "%s | Clavis",
  },
    ...
    images: [
      {
        ...
        width: 1500,
        height: 1016,
        alt: "Clavis — typing test with mechanical keyboard sounds, on-screen keyboard, and real-time WPM tracking",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Clavis — Typing Test with Mechanical Keyboard Sounds",
    description:
